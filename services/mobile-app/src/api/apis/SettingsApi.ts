...
import type { SettingsDetails } from "../models/index";
import {
...
export class SettingsApi extends runtime.BaseAPI {
  /**
   */
  async getCurrentSettingsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SettingsDetails>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SettingsDetailsFromJSON(jsonValue),
    );
  }
  ...
  /**
   */
  async updateCurrentSettingsRaw(
    requestParameters: UpdateCurrentSettingsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "body",
        "Required parameter requestParameters.body was null or undefined when calling updateCurrentSettings.",
      );
    }
