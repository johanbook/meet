...
export class ChatsApi extends runtime.BaseAPI {
  ...
  async createConversationRaw(
    ...
    if (
      requestParameters.createChatCommand === null ||
      requestParameters.createChatCommand === undefined
    ) {
      throw new runtime.RequiredError(
        "createChatCommand",
        "Required parameter requestParameters.createChatCommand was null or undefined when calling createConversation.",
      );
    }
  ...
  async getChatMessagesRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ChatMessageDetails>>> {
    if (
      ...
      throw new runtime.RequiredError(
        "conversationId",
        "Required parameter requestParameters.conversationId was null or undefined when calling getChatMessages.",
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ChatMessageDetailsFromJSON),
    );
  }
  ...
  async getChatMessages(
    requestParameters: GetChatMessagesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ChatMessageDetails>> {
  ...
  async getConversationsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ChatConversationDetails>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ChatConversationDetailsFromJSON),
    );
  }
  ...
  async getConversations(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ChatConversationDetails>> {
  ...
  /**
   */
  async postChatMessageRaw(
    requestParameters: PostChatMessageRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.postChatMessageCommand === null ||
      requestParameters.postChatMessageCommand === undefined
    ) {
      throw new runtime.RequiredError(
        "postChatMessageCommand",
        "Required parameter requestParameters.postChatMessageCommand was null or undefined when calling postChatMessage.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PostChatMessageCommandToJSON(
          requestParameters.postChatMessageCommand,
        ),
      },
      initOverrides,
    );
