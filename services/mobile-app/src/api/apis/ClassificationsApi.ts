...
import type { ClassificationDetails } from "../models/index";
import {
...
export class ClassificationsApi extends runtime.BaseAPI {
  /**
   */
  async getClassificationsRaw(
    requestParameters: GetClassificationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ClassificationDetails>>> {
    if (
      ...
      throw new runtime.RequiredError(
        "category",
        "Required parameter requestParameters.category was null or undefined when calling getClassifications.",
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ClassificationDetailsFromJSON),
    );
  }
  ...
  async getClassifications(
    requestParameters: GetClassificationsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ClassificationDetails>> {
    const response = await this.getClassificationsRaw(
      requestParameters,
      initOverrides,
    );
