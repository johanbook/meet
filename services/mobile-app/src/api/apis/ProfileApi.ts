...
export class ProfileApi extends runtime.BaseAPI {
  ...
  /**
   */
  async createCurrentProfileRaw(
    requestParameters: CreateCurrentProfileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.createProfileCommand === null ||
      requestParameters.createProfileCommand === undefined
    ) {
      throw new runtime.RequiredError(
        "createProfileCommand",
        "Required parameter requestParameters.createProfileCommand was null or undefined when calling createCurrentProfile.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: CreateProfileCommandToJSON(
          requestParameters.createProfileCommand,
        ),
      },
      initOverrides,
    );
  ...
  /**
   */
  async updateCurrentProfileRaw(
    requestParameters: UpdateCurrentProfileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.updateProfileCommand === null ||
      requestParameters.updateProfileCommand === undefined
    ) {
      throw new runtime.RequiredError(
        "updateProfileCommand",
        "Required parameter requestParameters.updateProfileCommand was null or undefined when calling updateCurrentProfile.",
      );
    }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UpdateProfileCommandToJSON(
          requestParameters.updateProfileCommand,
        ),
      },
      initOverrides,
    );
  ...
  /**
   */
  async updateCurrentProfilePhotoRaw(
    requestParameters: UpdateCurrentProfilePhotoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      ...
      throw new runtime.RequiredError(
        "photo",
        "Required parameter requestParameters.photo was null or undefined when calling updateCurrentProfilePhoto.",
      );
    }
