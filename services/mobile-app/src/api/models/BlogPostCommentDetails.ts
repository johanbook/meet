...
export function BlogPostCommentDetailsFromJSON(
  json: any,
): BlogPostCommentDetails {
  return BlogPostCommentDetailsFromJSONTyped(json, false);
}

export function BlogPostCommentDetailsFromJSONTyped(
  json: any,
...
export function BlogPostCommentDetailsToJSON(
  value?: BlogPostCommentDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
