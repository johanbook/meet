...
export function DeleteTimeSeriesPointCommandFromJSON(
  json: any,
): DeleteTimeSeriesPointCommand {
  return DeleteTimeSeriesPointCommandFromJSONTyped(json, false);
}

export function DeleteTimeSeriesPointCommandFromJSONTyped(
  json: any,
...
export function DeleteTimeSeriesPointCommandToJSON(
  value?: DeleteTimeSeriesPointCommand | null,
): any {
  if (value === undefined) {
    return undefined;
  }
