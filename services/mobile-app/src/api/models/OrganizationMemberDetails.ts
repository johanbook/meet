...
export type OrganizationMemberDetailsRoleEnum =
  (typeof OrganizationMemberDetailsRoleEnum)[keyof typeof OrganizationMemberDetailsRoleEnum];
...
export function OrganizationMemberDetailsFromJSON(
  json: any,
): OrganizationMemberDetails {
  return OrganizationMemberDetailsFromJSONTyped(json, false);
}

export function OrganizationMemberDetailsFromJSONTyped(
  json: any,
...
export function OrganizationMemberDetailsToJSON(
  value?: OrganizationMemberDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
