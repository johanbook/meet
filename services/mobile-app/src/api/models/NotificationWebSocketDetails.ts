...
export type NotificationWebSocketDetailsTypeEnum =
  (typeof NotificationWebSocketDetailsTypeEnum)[keyof typeof NotificationWebSocketDetailsTypeEnum];
...
export function NotificationWebSocketDetailsFromJSON(
  json: any,
): NotificationWebSocketDetails {
  return NotificationWebSocketDetailsFromJSONTyped(json, false);
}

export function NotificationWebSocketDetailsFromJSONTyped(
  json: any,
...
export function NotificationWebSocketDetailsToJSON(
  value?: NotificationWebSocketDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
