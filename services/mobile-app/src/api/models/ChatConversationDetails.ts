...
export function ChatConversationDetailsFromJSON(
  json: any,
): ChatConversationDetails {
  return ChatConversationDetailsFromJSONTyped(json, false);
}

export function ChatConversationDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    lastMessageSent: !exists(json, "lastMessageSent")
      ? undefined
      : new Date(json["lastMessageSent"]),
    name: json["name"],
...
export function ChatConversationDetailsToJSON(
  value?: ChatConversationDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    lastMessageSent:
      value.lastMessageSent === undefined
        ? undefined
        : value.lastMessageSent.toISOString(),
    name: value.name,
    profiles: (value.profiles as Array<any>).map(
      ChatMessageProfileDetailsToJSON,
    ),
  };
}
