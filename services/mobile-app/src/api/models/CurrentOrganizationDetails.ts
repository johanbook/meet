...
export type CurrentOrganizationDetailsFeaturesEnum =
  (typeof CurrentOrganizationDetailsFeaturesEnum)[keyof typeof CurrentOrganizationDetailsFeaturesEnum];
...
export type CurrentOrganizationDetailsRoleEnum =
  (typeof CurrentOrganizationDetailsRoleEnum)[keyof typeof CurrentOrganizationDetailsRoleEnum];
...
export type CurrentOrganizationDetailsThemeEnum =
  (typeof CurrentOrganizationDetailsThemeEnum)[keyof typeof CurrentOrganizationDetailsThemeEnum];
...
export function CurrentOrganizationDetailsFromJSON(
  json: any,
): CurrentOrganizationDetails {
  return CurrentOrganizationDetailsFromJSONTyped(json, false);
}

export function CurrentOrganizationDetailsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    id: json["id"],
    name: json["name"],
    photo: !exists(json, "photo")
      ? undefined
      : OrganizationPhotoDetailsFromJSON(json["photo"]),
  };
}

export function CurrentOrganizationDetailsToJSON(
  value?: CurrentOrganizationDetails | null,
): any {
  if (value === undefined) {
    return undefined;
  }
