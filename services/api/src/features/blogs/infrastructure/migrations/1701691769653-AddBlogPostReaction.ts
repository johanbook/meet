...
export class AddBlogPostReaction1701691769653 implements MigrationInterface {
    name = 'AddBlogPostReaction1701691769653'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "blog_post_reaction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "blogPostId" uuid NOT NULL, "profileId" integer NOT NULL, "reaction" character varying(8) NOT NULL DEFAULT '', CONSTRAINT "PK_5b5b61684e2a721319e12af41ba" PRIMARY KEY ("id"))`);
